...
class InstrumentsControllerTest < ActionController::TestCase
  ...
  test "should create instrument" do
    assert_difference('Instrument.count') do
      post :create, instrument: { description: @instrument.description, name: @instrument.name, price: @instrument.price }
    end
  ...
  test "should update instrument" do
    put :update, id: @instrument, instrument: { description: @instrument.description, name: @instrument.name, price: @instrument.price }
    assert_redirected_to instrument_path(assigns(:instrument))
  end
